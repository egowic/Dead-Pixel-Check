(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e=document.querySelector(`#app`);if(!e)throw Error(`App root was not found.`);var t=e,n=[{name:`Black`,value:`#000000`,textColor:`#f5f5f5`},{name:`White`,value:`#ffffff`,textColor:`#101010`},{name:`Red`,value:`#ff0000`,textColor:`#fff5f5`},{name:`Green`,value:`#00ff00`,textColor:`#03140a`},{name:`Blue`,value:`#0000ff`,textColor:`#f3f7ff`}],r={mode:`idle`,colorIndex:0,isFullscreen:!1},i=!1;function a(){return n[r.colorIndex]}function o(e=1){r.colorIndex=(r.colorIndex+e+n.length)%n.length,p()}async function s(){if(document.fullscreenEnabled)try{await document.documentElement.requestFullscreen()}catch{}}async function c(){if(document.fullscreenElement)try{await document.exitFullscreen()}catch{}}async function l(){r.mode=`testing`,r.colorIndex=0,document.documentElement.dataset.mode=r.mode,p(),await s()}async function u(){r.mode===`idle`||i||(i=!0,await c(),r.mode=`idle`,p(),i=!1)}function d(){t.innerHTML=`
  ...
  `;let e=t.querySelector(`[data-action="start"]`);e?.addEventListener(`pointerdown`,()=>{document.documentElement.dataset.mode=`testing`}),e?.addEventListener(`click`,()=>{l()})}function f(){let e=a();t.innerHTML=`
    <main
      class="test-surface"
      data-mode="testing"
      data-action="advance"
